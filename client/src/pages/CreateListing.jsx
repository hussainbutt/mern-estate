      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex gap-6 flex-wrap">
            ...
            <div className="flex gap-2">
              <input type="checkbox" onChange={handleChange} checked={formData.parking==true} id="parking" className="w-5" />
              <span>Parking</span>
            </div>
            <div className="flex gap-2">
              <input onChange={handleChange} checked={formData.furnished==true} type="checkbox" id="furnished" className="w-5" />
              <span>furnished</span>
            </div>
            <div className="flex gap-2">
              <input onChange={handleChange} checked={formData.offer==true} type="checkbox" id="offer" className="w-5" />
              <span>Offer</span>
            </div>
          </div>
...
hover:opacity-95 disabled: opacity-80" disabled={loading || uploading}
          >
